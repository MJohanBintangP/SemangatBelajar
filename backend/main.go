...
func main() {
	...
	http.HandleFunc("/api/tantangan/selesai", handlers.SelesaiTantanganHandler)
	http.HandleFunc("/api/tantangan/pending", handlers.GetPendingTantanganUser)
	...
	http.HandleFunc("/api/request-otp", handlers.RequestOTPHandler)
	http.HandleFunc("/api/verify-otp", handlers.VerifyOTPHandler)
	http.HandleFunc("/api/reset-password", handlers.ResetPasswordHandler)
	http.HandleFunc("/api/send-email-verification", handlers.SendEmailVerificationHandler)
	http.HandleFunc("/api/verify-email-otp", handlers.VerifyEmailOTPHandler)
