...
export default function Navbar() {
  ...
  return (
    <nav className="z-100 fixed top-0 lg:top-20 w-full">
      ...
      {isMobile && isMenuOpen && (
        <div className="bg-black/90 backdrop-blur-md w-full py-4 pb-10 px-6 flex flex-col">
          <ul className="flex flex-col space-y-4 mb-6">
            <li>
              <a onClick={() => scrollToSection('hero')} className="text-white font-medium hover:text-[#25E82F] transition-colors duration-150 block py-2">
                Home
              </a>
            </li>
            <li>
              <a onClick={() => scrollToSection('pengenalan')} className="text-white font-medium hover:text-[#25E82F] transition-colors duration-150 block py-2">
                Perkenalan
              </a>
            </li>
            <li>
              <a onClick={() => scrollToSection('video')} className="text-white font-medium hover:text-[#25E82F] transition-colors duration-150 block py-2">
                Video
              </a>
            </li>
            <li>
              <a onClick={() => scrollToSection('fitur')} className="text-white font-medium hover:text-[#25E82F] transition-colors duration-150 block py-2">
                Solusi
              </a>
            </li>
          </ul>
          <div className="flex flex-col space-y-3">
            <Link to="/Login" className="text-center hover:text-green-500 duration-200 transition-colors text-white border-2 py-2 rounded-full border-[#25E82F] font-medium">
              Masuk
            </Link>
            <Link to="/Register" className="text-center bg-[#25E82F] hover:bg-green-600 duration-200 transition-colors text-white py-2 rounded-full font-medium">
              Daftar
            </Link>
          </div>
        </div>
